...
import 'package:accountability/ui/components/page_components/issue_page_body.dart';
import 'package:accountability/ui/components/page_components/organization_page_body.dart';
import 'package:accountability/ui/components/page_components/leader_page_body.dart';
...
class FullCard extends StatelessWidget {
  // final PageID pageID;
  final String pageID;
  FullCard(this.pageID);
  Widget build(BuildContext context) {
    Future<PageFullData> page = getPageData(pageID);
    // PageFullData pageData = getPageData2(pageID);
    ...
    return FutureBuilder<PageFullData>(
        ...
        builder: (BuildContext context, AsyncSnapshot<PageFullData> snapshot) {
          if (snapshot.hasData == true) {
            return buildFullCard(snapshot.data, screenWidth, screenHeight);
          } else
            return buildFullCard(loaderData, screenWidth, screenHeight);
        });

    // return buildFullCard(pageData, screenWidth, screenHeight);
  }
}
          ...
          child: SizedBox(
              ...
              child: SingleChildScrollView(
                child: Card(
                  ...
                  children: [
                    // Image.asset(page.pageSummaryData.image,
