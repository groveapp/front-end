...
import 'package:grove_front_new/ui/shared/tables.dart';
...
import 'package:grove_front_new/core/providers/leader_provider.dart';
import 'package:horizontal_data_table/horizontal_data_table.dart';
import 'package:provider/provider.dart';
//import 'package:grove_front_new/core/models/page_models/leader_page_model.dart';
        ...
        child: isLoading
            ...
            Column(children: [
                    ...
                    Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                                width: 500,
                                child: BodyPlainReadMore(text: leader.bio))
                          ],
                        ))
                  ],
                ),
                ...
                Container(
                  ...
                  Head3Plain(text: "Past Votes"),
                  SizedBox(
                    height: 400,
                    width: 800,
                    child: _buildPastVotesTable(),
                  ),
                ])),
...
Widget _buildPastVotesTable() {
  return PastVotesTable(data: 1);
}
